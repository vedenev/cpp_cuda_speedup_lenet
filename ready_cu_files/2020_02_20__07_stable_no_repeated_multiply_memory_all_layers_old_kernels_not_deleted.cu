...
__global__ void convolutions_relu_constants_weights_shared_memory_old(int input_offset, float* features_input, int features_input_size_x, int features_input_size_y, int features_input_n_channels,
	...
	int biases_offset)
{
	...
	unsigned int features_output_size = features_output_step * features_output_n_channels;
...
__global__ void convolutions_relu_shared_memory_old(int input_offset, float* features_input, int features_input_size_x, int features_input_size_y, int features_input_n_channels,
	float* features_output, int features_output_size_x, int features_output_size_y, int features_output_n_channels,
...
__global__ void convolutions_shared_memory_old(int input_offset, float* features_input, int features_input_size_x, int features_input_size_y, int features_input_n_channels,
	float* features_output, int features_output_size_x, int features_output_size_y, int features_output_n_channels,
	float* weights, int weights_size_x, int weights_size_y,
	float* biases)
{
...
int main(void)
{
	...
	printf("input_step = %d\n", input_step);
	printf("input_size = %d\n", input_size);
	printf("featuremaps_1_size_y_x = %d\n", featuremaps_1_size_y_x);
	printf("W_conv1_step_1 = %d\n", W_conv1_step_1);
	printf("W_conv1_step_2 = %d\n", W_conv1_step_2);
	printf("featuremaps_1_thread_size = %d\n", featuremaps_1_thread_size);
	...
	for (int sample_count = 0; sample_count < n_samples; sample_count++)
	{
		...
		//convolutions_relu_constants_weights_shared_memory_old<<<grid_featuremaps_1, threadBlock_featuremaps_1>>> (input_offset, x_val, input_size_x, input_size_y, input_n_channels,
		//	featuremaps_1, featuremaps_1_size_x, featuremaps_1_size_y, featuremaps_1_n_channels,
		...
		//convolutions_relu_constants_weights_shared_memory_old<<<grid_featuremaps_2, threadBlock_featuremaps_2>>> (0, featuremaps_1_pooling, featuremaps_1_pooling_size_x, featuremaps_1_pooling_size_y, featuremaps_1_n_channels,
		...
		//convolutions_relu_shared_memory_old<<<grid_featuremaps_3, threadBlock_featuremaps_3>>> (0, featuremaps_2_pooling, featuremaps_2_pooling_size_x, featuremaps_2_pooling_size_y, featuremaps_2_n_channels,
		...
		//convolutions_shared_memory_old<<<grid_featuremaps_4, threadBlock_featuremaps_4>>> (0, featuremaps_3, featuremaps_3_size_x, featuremaps_3_size_y, featuremaps_3_n_channels,
